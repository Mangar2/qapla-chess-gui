...
namespace QaplaTest::SprtTournamentChatbot {
     ...
     * 
     * Precondition: SPRT tournament is running
     * Postcondition: 
     ...
     * @return true if step executed successfully
     * 
     * Precondition: SPRT tournament has scheduled tasks but is not running
     * Postcondition:
    ...
    /**
     * @brief Executes the SprtConfiguration step with specified action
     * @param ctx Test context
     * @param action Which button to click
     * @return true if step executed successfully
     */
    ...
    enum class StartAction {
        StartTournament,     // Click "Start SPRT Tournament"
        SwitchToView,        // Click "Switch to SPRT Tournament View" (after start)
